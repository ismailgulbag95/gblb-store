...
export const TRANSLATIONS = {
  tr: {
    ...
    unlock_tomato_farm_2: '2. Domates Tarlası Aç',
    unlock_tomato_shelf_2: '2. Domates Reyonu Kur',
    unlock_paste: 'Salça Kazanı Aç',
    unlock_orange: 'Portakal Bahçesi Aç',
    unlock_juice: 'Meyve Sıkacağı Kur',
    unlock_orange_farm_2: '2. Portakal Bahçesi Aç',
    unlock_corn: 'Mısır Tarlası Aç',
    unlock_corn_shelf: 'Taze Mısır Reyonu Aç',
    unlock_popcorn: 'Popcorn Makinesi Kur',
    unlock_feed_machine: 'Yem Değirmeni Makinesi Kur',
    unlock_coop: 'Tavuk Kümesi İnşa Et',
    buy_chicken_2: '2. Tavuğu Al (🐔 2x Yumurtlama)',
    buy_chicken_3: '3. Tavuğu Al (🐔 3x Yumurtlama)',
    ...
    char_robot: '🤖 Siber Lojistik Botu',
    char_robot_desc: 'Neon enerjili ve antenli fütüristik robot',
    char_panda: '🐼 Şef Panda',
    char_panda_desc: 'Kırmızı aşçı bandanalı, pofuduk sevimli fırıncı panda',
    char_penguin: '👑 Kral Penguen',
    char_penguin_desc: 'Altın taçlı ve smokinli karizmatik penguen patron',
    sfx: '🔊 Ses Efektleri',
    music: '🎵 Fon Müziği',
  ...
  en: {
    ...
    item_chicken_feed: 'Chicken Feed',
    item_egg: 'Farm Egg',
    ...
    unlock_tomato_farm_2: 'Unlock 2nd Tomato Field',
    unlock_tomato_shelf_2: 'Unlock 2nd Tomato Shelf',
    unlock_paste: 'Unlock Tomato Paste Vat',
    unlock_orange: 'Unlock Orange Orchard',
    unlock_juice: 'Unlock Juicer Station',
    unlock_orange_farm_2: 'Unlock 2nd Orange Field',
    unlock_corn: 'Unlock Corn Field',
    unlock_corn_shelf: 'Unlock Fresh Corn Shelf',
    unlock_popcorn: 'Unlock Popcorn Machine',
    unlock_feed_machine: 'Unlock Feed Grinder Machine',
    unlock_coop: 'Build Chicken Coop',
    buy_chicken_2: 'Buy 2nd Chicken (🐔 2x Lay Speed)',
    buy_chicken_3: 'Buy 3rd Chicken (🐔 3x Lay Speed)',
    unlock_wheat: 'Unlock Wheat Field',
    unlock_bakery: 'Unlock Stone Oven Bakery',
    unlock_restaurant: 'Unlock Restaurant Complex',
    unlock_burger: 'Burger Grill Station',
    unlock_pizza: 'Pizza Oven Station',
    unlock_tables: 'Build Dining Tables',
    upgrade_backpack: 'Backpack Capacity +4',
    ...
    char_robot: '🤖 Cyber Bot',
    char_robot_desc: 'Futuristic neon-powered logistics android with antenna',
    char_panda: '🐼 Chef Panda',
    char_panda_desc: 'Cute fluffy panda baker with red chef bandana',
    char_penguin: '👑 King Penguin',
    char_penguin_desc: 'Charismatic penguin boss in tuxedo and golden crown',
    sfx: '🔊 Sound Effects',
    music: '🎵 Music',
